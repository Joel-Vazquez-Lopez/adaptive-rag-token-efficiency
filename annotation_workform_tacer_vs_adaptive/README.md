...
This workform compares Fixed Top-10, Adaptive-k, and TACER on saved Llama-70B outputs.
...
- Queries: 20 HotpotQA + 20 ASQA
- Answers to annotate: 120
- Systems are blinded as System A/B/C inside each query group.
